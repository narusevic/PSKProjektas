...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        ...
        <div class="container">
            <div class="card mb-3">
                <div class="card-header">Register the location</div>
                <div class="card-body">
                    <form:form method="POST" modelAttribute="locationForm" class="form-signin">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active">Enter the city</li>
                        </ol>
                        ...
                        <br/>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active">Enter the country</li>
                        </ol>
                        ...
                        <br/>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active">Does DevBridge have office in this city?</li>
                        </ol>
                        <spring:bind path="devBridge">
                            <div align="left" class="form-control" class="form-group ${status.error ? 'has-error':''}">
                                <form:checkbox path="devBridge"></form:checkbox>
                            </div>
                        </spring:bind>
                        <br/>
                        <br/>
