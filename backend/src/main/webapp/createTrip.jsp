...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        ...
        <div class="container">
            <div class="card mb-3">
                <div class="card-header">Create a trip</div>
                <div class="card-body">
                    <form:form method="POST" modelAttribute="tripForm" class="form-signin">
                        ...
                        <div>
                            <form:select path="startPlace" class="form-control">
                        ...
                        <br/>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active">Status of the trip</li>
                        </ol>
                        <spring:bind path="status">
                        <div>
                            <form:select path="status"  class="form-control" items="${statuses}"/>
                        </div>
                        </spring:bind>
